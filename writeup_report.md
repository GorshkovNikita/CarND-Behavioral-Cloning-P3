...
filter sizes and depths between 24 and 64 (model.py lines 72-76)

The model includes RELU layers to introduce nonlinearity,
and the data is normalized in the model using a Keras lambda layer (code line 71).
...
To capture good driving behavior, I first recorded four laps on track one in each direction (clockwise and counterclockwise) 
